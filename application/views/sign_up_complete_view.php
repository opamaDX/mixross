                ...
                <div class="row h-200vh">
                    <div class="col-md-9 col-lg-10 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                        <div class="background-white radius-secondary p-4 p-md-5 mt-5" data-zanim='{"delay":0.1}'>
                            ...
                            <div class="row">
                                <h5 class="col-12 border-bottom text-left">仮登録完了</h5>

                                <h4 class="col-12 mt-5">仮登録が完了しました！</h4><br>
                                <div class="mt-4 mail" style="margin:0 auto"></div>
                                <p class="col-12 mt-8">確認メールを送信しました。</p>
                                <p class="col-12 mt-4">（登録はまだ完了しておりません）</p>
                                <p class="col-12 mt-4">24時間以内に、メール本文内の「会員登録完了」ボタンをクリック頂くと登録が完了致します。</p>
                            </div>
                        </div>
                    </div>
                </div>
